"""
5 sub processes are used to run in parallel on a PC (have not been checked on cluster)
Make sure to run ZEUS2e16_multiprocessing to generate the input files in the input_modules file
"""
