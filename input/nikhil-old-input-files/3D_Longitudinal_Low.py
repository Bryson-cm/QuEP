...
iterations = 500000
mode = -1
fname = "3D_Longitudinal_Low.npz"
debugmode = False

# Probe centered at the following initial coordinates (in c/w_p):
x_c = -2.4 # Start within region of field # 2.4 = maximum x_c
y_c = 0
xi_c = -11.29059131  # Such that probe still hits y = 0, xi = -11.4

# Initial momentum
px_0 = 9.729608768 # Make sure it goes towards the screen!
py_0 = 0
pz_0 = 107.6296602
